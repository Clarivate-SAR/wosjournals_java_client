...
import com.clarivate.wos.wos_journals_client.model.CategoriesCitedHits;
...
public class CategoriesCited {
  ...
  private List<CategoriesCitedHits> hits = null;

  public CategoriesCited() { 
  }

  public CategoriesCited metadata(Metadata metadata) {
  ...
  **/
  ...
  public CategoriesCited hits(List<CategoriesCitedHits> hits) {
    
    this.hits = hits;
    return this;
  }

  public CategoriesCited addHitsItem(CategoriesCitedHits hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<CategoriesCitedHits>();
    }
  ...
  **/
  ...
  public List<CategoriesCitedHits> getHits() {
    return hits;
  }


  public void setHits(List<CategoriesCitedHits> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoriesCited categoriesCited = (CategoriesCited) o;
    return Objects.equals(this.metadata, categoriesCited.metadata) &&
        Objects.equals(this.hits, categoriesCited.hits);
  }
  ...
  public String toString() {
    ...
    sb.append("class CategoriesCited {\n");
