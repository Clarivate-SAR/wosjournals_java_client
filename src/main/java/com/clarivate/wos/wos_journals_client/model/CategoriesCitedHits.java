...
import com.clarivate.wos.wos_journals_client.model.CategoriesCitedJournal;
...
public class CategoriesCitedHits {
  public static final String SERIALIZED_NAME_JOURNAL = "journal";
  @SerializedName(SERIALIZED_NAME_JOURNAL)
  private CategoriesCitedJournal journal;

  public static final String SERIALIZED_NAME_CITING = "citing";
  @SerializedName(SERIALIZED_NAME_CITING)
  private List<Object> citing = null;

  public CategoriesCitedHits() { 
  }

  public CategoriesCitedHits journal(CategoriesCitedJournal journal) {
  ...
  **/
  ...
  public CategoriesCitedJournal getJournal() {
    return journal;
  }


  public void setJournal(CategoriesCitedJournal journal) {
    this.journal = journal;
  }


  public CategoriesCitedHits citing(List<Object> citing) {
    
    this.citing = citing;
    return this;
  }

  public CategoriesCitedHits addCitingItem(Object citingItem) {
    if (this.citing == null) {
      this.citing = new ArrayList<Object>();
    }
    this.citing.add(citingItem);
    return this;
  }
  ...
  **/
  ...
  public List<Object> getCiting() {
    return citing;
  }


  public void setCiting(List<Object> citing) {
    this.citing = citing;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoriesCitedHits categoriesCitedHits = (CategoriesCitedHits) o;
    return Objects.equals(this.journal, categoriesCitedHits.journal) &&
        Objects.equals(this.citing, categoriesCitedHits.citing);
  }

  @Override
  public int hashCode() {
    return Objects.hash(journal, citing);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoriesCitedHits {\n");
    sb.append("    journal: ").append(toIndentedString(journal)).append("\n");
    sb.append("    citing: ").append(toIndentedString(citing)).append("\n");
    sb.append("}");
    return sb.toString();
  }
