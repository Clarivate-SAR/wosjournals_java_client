...
public class CategoriesCitedJournal {
  ...
  public static final String SERIALIZED_NAME_CITED_JOURNALS = "citedJournals";
  @SerializedName(SERIALIZED_NAME_CITED_JOURNALS)
  private Integer citedJournals;

  public CategoriesCitedJournal() { 
  }

  public CategoriesCitedJournal self(String self) {
  ...
  **/
  ...
  public CategoriesCitedJournal name(String name) {
  ...
  **/
  ...
  public CategoriesCitedJournal citedJournals(Integer citedJournals) {
    
    this.citedJournals = citedJournals;
    return this;
  }

   /**
   * Get citedJournals
   * @return citedJournals
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getCitedJournals() {
    return citedJournals;
  }


  public void setCitedJournals(Integer citedJournals) {
    this.citedJournals = citedJournals;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoriesCitedJournal categoriesCitedJournal = (CategoriesCitedJournal) o;
    return Objects.equals(this.self, categoriesCitedJournal.self) &&
        Objects.equals(this.name, categoriesCitedJournal.name) &&
        Objects.equals(this.citedJournals, categoriesCitedJournal.citedJournals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(self, name, citedJournals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoriesCitedJournal {\n");
    sb.append("    self: ").append(toIndentedString(self)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    citedJournals: ").append(toIndentedString(citedJournals)).append("\n");
    sb.append("}");
    return sb.toString();
  }
