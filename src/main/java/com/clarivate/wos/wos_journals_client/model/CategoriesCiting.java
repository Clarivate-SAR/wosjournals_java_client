...
import com.clarivate.wos.wos_journals_client.model.CategoriesCitingHits;
import com.clarivate.wos.wos_journals_client.model.Metadata;
...
public class CategoriesCiting {
  ...
  private List<CategoriesCitingHits> hits = null;

  public CategoriesCiting() { 
  }

  public CategoriesCiting metadata(Metadata metadata) {
  ...
  **/
  ...
  public CategoriesCiting hits(List<CategoriesCitingHits> hits) {
    
    this.hits = hits;
    return this;
  }

  public CategoriesCiting addHitsItem(CategoriesCitingHits hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<CategoriesCitingHits>();
    }
  ...
  **/
  ...
  public List<CategoriesCitingHits> getHits() {
    return hits;
  }


  public void setHits(List<CategoriesCitingHits> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoriesCiting categoriesCiting = (CategoriesCiting) o;
    return Objects.equals(this.metadata, categoriesCiting.metadata) &&
        Objects.equals(this.hits, categoriesCiting.hits);
  }
  ...
  public String toString() {
    ...
    sb.append("class CategoriesCiting {\n");
