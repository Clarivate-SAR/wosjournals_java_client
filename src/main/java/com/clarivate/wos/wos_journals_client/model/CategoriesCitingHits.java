...
import com.clarivate.wos.wos_journals_client.model.CategoriesCitingJournal;
...
public class CategoriesCitingHits {
  public static final String SERIALIZED_NAME_JOURNAL = "journal";
  @SerializedName(SERIALIZED_NAME_JOURNAL)
  private CategoriesCitingJournal journal;

  public static final String SERIALIZED_NAME_CITED = "cited";
  @SerializedName(SERIALIZED_NAME_CITED)
  private List<Object> cited = null;

  public CategoriesCitingHits() { 
  }

  public CategoriesCitingHits journal(CategoriesCitingJournal journal) {
  ...
  **/
  ...
  public CategoriesCitingJournal getJournal() {
    return journal;
  }


  public void setJournal(CategoriesCitingJournal journal) {
    this.journal = journal;
  }


  public CategoriesCitingHits cited(List<Object> cited) {
    
    this.cited = cited;
    return this;
  }

  public CategoriesCitingHits addCitedItem(Object citedItem) {
    if (this.cited == null) {
      this.cited = new ArrayList<Object>();
    }
    this.cited.add(citedItem);
    return this;
  }
  ...
  **/
  ...
  public List<Object> getCited() {
    return cited;
  }


  public void setCited(List<Object> cited) {
    this.cited = cited;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoriesCitingHits categoriesCitingHits = (CategoriesCitingHits) o;
    return Objects.equals(this.journal, categoriesCitingHits.journal) &&
        Objects.equals(this.cited, categoriesCitingHits.cited);
  }

  @Override
  public int hashCode() {
    return Objects.hash(journal, cited);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoriesCitingHits {\n");
    sb.append("    journal: ").append(toIndentedString(journal)).append("\n");
    sb.append("    cited: ").append(toIndentedString(cited)).append("\n");
    sb.append("}");
    return sb.toString();
  }
