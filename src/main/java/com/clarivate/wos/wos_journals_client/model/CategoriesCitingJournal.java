...
public class CategoriesCitingJournal {
  ...
  public static final String SERIALIZED_NAME_CITING_JOURNALS = "citingJournals";
  @SerializedName(SERIALIZED_NAME_CITING_JOURNALS)
  private Integer citingJournals;

  public CategoriesCitingJournal() { 
  }

  public CategoriesCitingJournal self(String self) {
  ...
  **/
  ...
  public CategoriesCitingJournal name(String name) {
  ...
  **/
  ...
  public CategoriesCitingJournal citingJournals(Integer citingJournals) {
    
    this.citingJournals = citingJournals;
    return this;
  }

   /**
   * Get citingJournals
   * @return citingJournals
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getCitingJournals() {
    return citingJournals;
  }


  public void setCitingJournals(Integer citingJournals) {
    this.citingJournals = citingJournals;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoriesCitingJournal categoriesCitingJournal = (CategoriesCitingJournal) o;
    return Objects.equals(this.self, categoriesCitingJournal.self) &&
        Objects.equals(this.name, categoriesCitingJournal.name) &&
        Objects.equals(this.citingJournals, categoriesCitingJournal.citingJournals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(self, name, citingJournals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoriesCitingJournal {\n");
    sb.append("    self: ").append(toIndentedString(self)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    citingJournals: ").append(toIndentedString(citingJournals)).append("\n");
    sb.append("}");
    return sb.toString();
  }
