...
import com.clarivate.wos.wos_journals_client.model.CategoryListRecord;
...
public class CategoryList {
  ...
  private List<CategoryListRecord> hits = null;

  public CategoryList() { 
  }

  public CategoryList metadata(Metadata metadata) {
  ...
  **/
  ...
  public CategoryList hits(List<CategoryListRecord> hits) {
    
    this.hits = hits;
    return this;
  }

  public CategoryList addHitsItem(CategoryListRecord hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<CategoryListRecord>();
    }
   ...
   /**
   * List of retrieved categories
   * @return hits
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of retrieved categories")

  public List<CategoryListRecord> getHits() {
    return hits;
  }


  public void setHits(List<CategoryListRecord> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, categoryList.metadata) &&
        Objects.equals(this.hits, categoryList.hits);
  }
