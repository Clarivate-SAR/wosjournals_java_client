...
public class CategoryListRecord {
  ...
  public static final String SERIALIZED_NAME_CATEGORY_CITATION_REPORTS = "categoryCitationReports";
  @SerializedName(SERIALIZED_NAME_CATEGORY_CITATION_REPORTS)
  private List<Object> categoryCitationReports = null;

  public CategoryListRecord() { 
  }

  public CategoryListRecord id(String id) {
  ...
  **/
  ...
  public CategoryListRecord self(String self) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link to the category entity")
  ...
  public CategoryListRecord matches(List<SearchMatch> matches) {
    
    this.matches = matches;
    return this;
  }

  public CategoryListRecord addMatchesItem(SearchMatch matchesItem) {
   ...
   /**
   * Search string matches across category names
   * @return matches
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Search string matches across category names")
  ...
  public CategoryListRecord name(String name) {
  ...
  **/
  ...
  public CategoryListRecord edition(String edition) {
   ...
   /**
   * Category edition (SCIE/SSCI)
   * @return edition
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Category edition (SCIE/SSCI)")
  ...
  public CategoryListRecord categoryCitationReports(List<Object> categoryCitationReports) {
    
    this.categoryCitationReports = categoryCitationReports;
    return this;
  }

  public CategoryListRecord addCategoryCitationReportsItem(Object categoryCitationReportsItem) {
    if (this.categoryCitationReports == null) {
      this.categoryCitationReports = new ArrayList<Object>();
    }
    this.categoryCitationReports.add(categoryCitationReportsItem);
    return this;
  }

   /**
   * Get categoryCitationReports
   * @return categoryCitationReports
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<Object> getCategoryCitationReports() {
    return categoryCitationReports;
  }


  public void setCategoryCitationReports(List<Object> categoryCitationReports) {
    this.categoryCitationReports = categoryCitationReports;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoryListRecord categoryListRecord = (CategoryListRecord) o;
    return Objects.equals(this.id, categoryListRecord.id) &&
        Objects.equals(this.self, categoryListRecord.self) &&
        Objects.equals(this.matches, categoryListRecord.matches) &&
        Objects.equals(this.name, categoryListRecord.name) &&
        Objects.equals(this.edition, categoryListRecord.edition) &&
        Objects.equals(this.categoryCitationReports, categoryListRecord.categoryCitationReports);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, self, matches, name, edition, categoryCitationReports);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoryListRecord {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    self: ").append(toIndentedString(self)).append("\n");
    sb.append("    matches: ").append(toIndentedString(matches)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    edition: ").append(toIndentedString(edition)).append("\n");
    sb.append("    categoryCitationReports: ").append(toIndentedString(categoryCitationReports)).append("\n");
    sb.append("}");
    return sb.toString();
  }
