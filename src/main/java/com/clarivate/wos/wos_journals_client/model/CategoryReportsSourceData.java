...
import com.clarivate.wos.wos_journals_client.model.CategoryReportsSourceDataArticles;
import com.clarivate.wos.wos_journals_client.model.CategoryReportsSourceDataReviews;
import com.clarivate.wos.wos_journals_client.model.SourceDataArticles;
 ...
 */
@ApiModel(description = "Aggregate Source Data counting the number of citable items and the number of cited references in each type of item.")
...
public class CategoryReportsSourceData {
  public static final String SERIALIZED_NAME_ARTICLES = "articles";
  @SerializedName(SERIALIZED_NAME_ARTICLES)
  private CategoryReportsSourceDataArticles articles;

  public static final String SERIALIZED_NAME_REVIEWS = "reviews";
  @SerializedName(SERIALIZED_NAME_REVIEWS)
  private CategoryReportsSourceDataReviews reviews;

  public static final String SERIALIZED_NAME_OTHER = "other";
  @SerializedName(SERIALIZED_NAME_OTHER)
  private SourceDataArticles other;

  public CategoryReportsSourceData() { 
  }

  public CategoryReportsSourceData articles(CategoryReportsSourceDataArticles articles) {
  ...
  **/
  ...
  public CategoryReportsSourceDataArticles getArticles() {
    return articles;
  }


  public void setArticles(CategoryReportsSourceDataArticles articles) {
    this.articles = articles;
  }


  public CategoryReportsSourceData reviews(CategoryReportsSourceDataReviews reviews) {
  ...
  **/
  ...
  public CategoryReportsSourceDataReviews getReviews() {
    return reviews;
  }


  public void setReviews(CategoryReportsSourceDataReviews reviews) {
    this.reviews = reviews;
  }


  public CategoryReportsSourceData other(SourceDataArticles other) {
  ...
  **/
  ...
  public SourceDataArticles getOther() {
    return other;
  }


  public void setOther(SourceDataArticles other) {
    this.other = other;
  }
  ...
  public boolean equals(Object o) {
    ...
    CategoryReportsSourceData categoryReportsSourceData = (CategoryReportsSourceData) o;
    return Objects.equals(this.articles, categoryReportsSourceData.articles) &&
        Objects.equals(this.reviews, categoryReportsSourceData.reviews) &&
        Objects.equals(this.other, categoryReportsSourceData.other);
  }

  @Override
  public int hashCode() {
    return Objects.hash(articles, reviews, other);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoryReportsSourceData {\n");
