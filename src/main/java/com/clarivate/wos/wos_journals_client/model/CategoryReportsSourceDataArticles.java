...
public class CategoryReportsSourceDataArticles {
  ...
  public CategoryReportsSourceDataArticles() { 
  }

  public CategoryReportsSourceDataArticles count(Integer count) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Total count of articles")
  ...
  public CategoryReportsSourceDataArticles references(Integer references) {
   ...
   /**
   * Total count of article references
   * @return references
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total count of article references")
  ...
  public boolean equals(Object o) {
    ...
    CategoryReportsSourceDataArticles categoryReportsSourceDataArticles = (CategoryReportsSourceDataArticles) o;
    return Objects.equals(this.count, categoryReportsSourceDataArticles.count) &&
        Objects.equals(this.references, categoryReportsSourceDataArticles.references);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, references);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoryReportsSourceDataArticles {\n");
