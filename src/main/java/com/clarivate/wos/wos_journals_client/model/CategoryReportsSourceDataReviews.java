...
public class CategoryReportsSourceDataReviews {
  ...
  public CategoryReportsSourceDataReviews() { 
  }

  public CategoryReportsSourceDataReviews count(Integer count) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Total count of reviews")
  ...
  public CategoryReportsSourceDataReviews references(Integer references) {
   ...
   /**
   * Total count of review references
   * @return references
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total count of review references")
  ...
  public boolean equals(Object o) {
    ...
    CategoryReportsSourceDataReviews categoryReportsSourceDataReviews = (CategoryReportsSourceDataReviews) o;
    return Objects.equals(this.count, categoryReportsSourceDataReviews.count) &&
        Objects.equals(this.references, categoryReportsSourceDataReviews.references);
  }
  ...
  public String toString() {
    ...
    sb.append("class CategoryReportsSourceDataReviews {\n");
