...
public class CitedData {
  ...
  public CitedData url(String url) {
   ...
   /**
   * Link to the Cited endpoint for the JCR year.
   * @return url
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link to the Cited endpoint for the JCR year.")
  ...
  public CitedData count(Integer count) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of cited journals")
  ...
  public boolean equals(Object o) {
    ...
    CitedData citedData = (CitedData) o;
    return Objects.equals(this.url, citedData.url) &&
        Objects.equals(this.count, citedData.count);
  }
