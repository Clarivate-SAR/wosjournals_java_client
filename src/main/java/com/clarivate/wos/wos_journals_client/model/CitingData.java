...
public class CitingData {
  ...
  public CitingData url(String url) {
   ...
   /**
   * Link to the Citing endpoint for the JCR year.
   * @return url
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link to the Citing endpoint for the JCR year.")
  ...
  public CitingData count(Integer count) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of citing journals")
  ...
  public boolean equals(Object o) {
    ...
    CitingData citingData = (CitingData) o;
    return Objects.equals(this.url, citingData.url) &&
        Objects.equals(this.count, citingData.count);
  }
