...
public class Immediacy {
  public static final String SERIALIZED_NAME_COUNT = "count";
  @SerializedName(SERIALIZED_NAME_COUNT)
  private Double count;

  public static final String SERIALIZED_NAME_CITES_CURRENT_YEAR = "citesCurrentYear";
  @SerializedName(SERIALIZED_NAME_CITES_CURRENT_YEAR)
  private Integer citesCurrentYear;

  public static final String SERIALIZED_NAME_PUBLISHED_CURRENT_YEAR = "publishedCurrentYear";
  @SerializedName(SERIALIZED_NAME_PUBLISHED_CURRENT_YEAR)
  private Integer publishedCurrentYear;

  public Immediacy() { 
  }

  public Immediacy count(Double count) {
  ...
  **/
  ...
  public Immediacy citesCurrentYear(Integer citesCurrentYear) {
    
    this.citesCurrentYear = citesCurrentYear;
    return this;
  }

   /**
   * Get citesCurrentYear
   * @return citesCurrentYear
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getCitesCurrentYear() {
    return citesCurrentYear;
  }


  public void setCitesCurrentYear(Integer citesCurrentYear) {
    this.citesCurrentYear = citesCurrentYear;
  }


  public Immediacy publishedCurrentYear(Integer publishedCurrentYear) {
    
    this.publishedCurrentYear = publishedCurrentYear;
    return this;
  }

   /**
   * Get publishedCurrentYear
   * @return publishedCurrentYear
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getPublishedCurrentYear() {
    return publishedCurrentYear;
  }


  public void setPublishedCurrentYear(Integer publishedCurrentYear) {
    this.publishedCurrentYear = publishedCurrentYear;
  }
  ...
  public boolean equals(Object o) {
    ...
    Immediacy immediacy = (Immediacy) o;
    return Objects.equals(this.count, immediacy.count) &&
        Objects.equals(this.citesCurrentYear, immediacy.citesCurrentYear) &&
        Objects.equals(this.publishedCurrentYear, immediacy.publishedCurrentYear);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, citesCurrentYear, publishedCurrentYear);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Immediacy {\n");
    sb.append("    count: ").append(toIndentedString(count)).append("\n");
    sb.append("    citesCurrentYear: ").append(toIndentedString(citesCurrentYear)).append("\n");
    sb.append("    publishedCurrentYear: ").append(toIndentedString(publishedCurrentYear)).append("\n");
    sb.append("}");
    return sb.toString();
  }
