...
package com.clarivate.wos.wos_journals_client.model;
 ...
 * ImpactMetrics
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-04-06T14:50:48.148+02:00[Europe/Paris]")
public class ImpactMetrics {
  public static final String SERIALIZED_NAME_TOTAL_CITES = "totalCites";
  @SerializedName(SERIALIZED_NAME_TOTAL_CITES)
  ...
  public static final String SERIALIZED_NAME_JIF_WITHOUT_SELF_CITATIONS = "jifWithoutSelfCitations";
  @SerializedName(SERIALIZED_NAME_JIF_WITHOUT_SELF_CITATIONS)
  private String jifWithoutSelfCitations;

  public static final String SERIALIZED_NAME_JIF5_YEARS = "jif5Years";
  @SerializedName(SERIALIZED_NAME_JIF5_YEARS)
  private Double jif5Years;
  ...
  public ImpactMetrics totalCites(Integer totalCites) {
   ...
   /**
   * The total number of times that a journal has been cited by all journals included in the database in the JCR year. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor38)
   * @return totalCites
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total number of times that a journal has been cited by all journals included in the database in the JCR year. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor38)")

  public Integer getTotalCites() {
    return totalCites;
  }


  public void setTotalCites(Integer totalCites) {
    this.totalCites = totalCites;
  }


  public ImpactMetrics jif(String jif) {
   ...
   /**
   * Journal Impact Factor. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor28)
   * @return jif
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Journal Impact Factor. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor28)")
  ...
  public ImpactMetrics jifWithoutSelfCitations(String jifWithoutSelfCitations) {
    
    this.jifWithoutSelfCitations = jifWithoutSelfCitations;
    return this;
  }

   /**
   * Journal Impact Factor without self cites.
   * @return jifWithoutSelfCitations
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Journal Impact Factor without self cites.")

  public String getJifWithoutSelfCitations() {
    return jifWithoutSelfCitations;
  }


  public void setJifWithoutSelfCitations(String jifWithoutSelfCitations) {
    this.jifWithoutSelfCitations = jifWithoutSelfCitations;
  }


  public ImpactMetrics jif5Years(Double jif5Years) {
    
    this.jif5Years = jif5Years;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Average number of times articles from the journal published in the past five years have been cited in the JCR year")

  public Double getJif5Years() {
    return jif5Years;
  }


  public void setJif5Years(Double jif5Years) {
    this.jif5Years = jif5Years;
  }


  public ImpactMetrics immediacyIndex(Double immediacyIndex) {
   ...
   /**
   * Average number of times an article is cited in the year it is published. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor25)
   * @return immediacyIndex
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Average number of times an article is cited in the year it is published. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor25)")
  ...
  public void setImmediacyIndex(Double immediacyIndex) {
    this.immediacyIndex = immediacyIndex;
  }


  public ImpactMetrics jci(Double jci) {
   ...
   /**
   * The Journal Citation Indicator is a new field-normalized metric that is calculated for all journals in the Web of Science Core Collection. The value represents the average category-normalized citation impact for papers published in the prior three-year period.
   * @return jci
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Journal Citation Indicator is a new field-normalized metric that is calculated for all journals in the Web of Science Core Collection. The value represents the average category-normalized citation impact for papers published in the prior three-year period.")

  public Double getJci() {
    return jci;
  }


  public void setJci(Double jci) {
    this.jci = jci;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCites, impactMetrics.totalCites) &&
        Objects.equals(this.jif, impactMetrics.jif) &&
        Objects.equals(this.jifWithoutSelfCitations, impactMetrics.jifWithoutSelfCitations) &&
        Objects.equals(this.jif5Years, impactMetrics.jif5Years) &&
        Objects.equals(this.immediacyIndex, impactMetrics.immediacyIndex) &&
        Objects.equals(this.jci, impactMetrics.jci);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalCites, jif, jifWithoutSelfCitations, jif5Years, immediacyIndex, jci);
  }
  ...
  public String toString() {
    ...
    sb.append("    totalCites: ").append(toIndentedString(totalCites)).append("\n");
    sb.append("    jif: ").append(toIndentedString(jif)).append("\n");
    sb.append("    jifWithoutSelfCitations: ").append(toIndentedString(jifWithoutSelfCitations)).append("\n");
    sb.append("    jif5Years: ").append(toIndentedString(jif5Years)).append("\n");
