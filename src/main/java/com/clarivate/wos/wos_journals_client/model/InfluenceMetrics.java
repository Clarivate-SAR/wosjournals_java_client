...
import com.clarivate.wos.wos_journals_client.model.InfluenceMetricsEigenFactor;
...
public class InfluenceMetrics {
  public static final String SERIALIZED_NAME_EIGEN_FACTOR = "eigenFactor";
  @SerializedName(SERIALIZED_NAME_EIGEN_FACTOR)
  private InfluenceMetricsEigenFactor eigenFactor;
  ...
  private Double articleInfluence;

  public InfluenceMetrics() { 
  }

  public InfluenceMetrics eigenFactor(InfluenceMetricsEigenFactor eigenFactor) {
  ...
  **/
  ...
  public InfluenceMetricsEigenFactor getEigenFactor() {
    return eigenFactor;
  }


  public void setEigenFactor(InfluenceMetricsEigenFactor eigenFactor) {
    this.eigenFactor = eigenFactor;
  }


  public InfluenceMetrics articleInfluence(Double articleInfluence) {
   ...
   /**
   * Article influence metrics. For more information, please visit [this page](http://jcr.help.clarivate.com/Content/glossary-article-influence-score.htm)
   * @return articleInfluence
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Article influence metrics. For more information, please visit [this page](http://jcr.help.clarivate.com/Content/glossary-article-influence-score.htm)")

  public Double getArticleInfluence() {
    return articleInfluence;
  }


  public void setArticleInfluence(Double articleInfluence) {
    this.articleInfluence = articleInfluence;
  }
  ...
  public boolean equals(Object o) {
    ...
    InfluenceMetrics influenceMetrics = (InfluenceMetrics) o;
    return Objects.equals(this.eigenFactor, influenceMetrics.eigenFactor) &&
        Objects.equals(this.articleInfluence, influenceMetrics.articleInfluence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eigenFactor, articleInfluence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InfluenceMetrics {\n");
    sb.append("    eigenFactor: ").append(toIndentedString(eigenFactor)).append("\n");
