 ...
 */
@ApiModel(description = "Eigenfactor score metrics (score and normalized score), available for journals reports dated 2007 or later. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor23)")
...
public class InfluenceMetricsEigenFactor {
  ...
  public InfluenceMetricsEigenFactor() { 
  }

  public InfluenceMetricsEigenFactor score(Double score) {
   ...
   /**
   * Eigenfactor score. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor24)
   * @return score
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Eigenfactor score. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor24)")
  ...
  public InfluenceMetricsEigenFactor normalized(Double normalized) {
   ...
   /**
   * Normalized Eigenfactor score. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor33)
   * @return normalized
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Normalized Eigenfactor score. For more information, please visit the [JCR Glossary page](http://jcr.help.clarivate.com/Content/glossary.htm#610062182_anchor33)")
  ...
  public boolean equals(Object o) {
    ...
    InfluenceMetricsEigenFactor influenceMetricsEigenFactor = (InfluenceMetricsEigenFactor) o;
    return Objects.equals(this.score, influenceMetricsEigenFactor.score) &&
        Objects.equals(this.normalized, influenceMetricsEigenFactor.normalized);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, normalized);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InfluenceMetricsEigenFactor {\n");
