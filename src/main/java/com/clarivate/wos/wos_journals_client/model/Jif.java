...
import com.clarivate.wos.wos_journals_client.model.JifAggregate;
...
public class Jif {
  ...
  private JifAggregate aggregate;

  public Jif() { 
  }

  public Jif median(Double median) {
  ...
  **/
  ...
  public Jif aggregate(JifAggregate aggregate) {
  ...
  **/
  ...
  public JifAggregate getAggregate() {
    return aggregate;
  }


  public void setAggregate(JifAggregate aggregate) {
    this.aggregate = aggregate;
  }
  ...
  public boolean equals(Object o) {
    ...
    Jif jif = (Jif) o;
    return Objects.equals(this.median, jif.median) &&
        Objects.equals(this.aggregate, jif.aggregate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(median, aggregate);
  }
