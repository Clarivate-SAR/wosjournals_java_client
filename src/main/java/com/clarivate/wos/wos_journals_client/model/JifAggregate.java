...
public class JifAggregate {
  public static final String SERIALIZED_NAME_COUNT = "count";
  @SerializedName(SERIALIZED_NAME_COUNT)
  private String count;

  public static final String SERIALIZED_NAME_CITES_YEAR_AGO = "citesYearAgo";
  @SerializedName(SERIALIZED_NAME_CITES_YEAR_AGO)
  private Integer citesYearAgo;

  public static final String SERIALIZED_NAME_CITES_TWO_YEARS_AGO = "citesTwoYearsAgo";
  @SerializedName(SERIALIZED_NAME_CITES_TWO_YEARS_AGO)
  private Integer citesTwoYearsAgo;

  public static final String SERIALIZED_NAME_PUBLISHED_YEAR_AGO = "publishedYearAgo";
  @SerializedName(SERIALIZED_NAME_PUBLISHED_YEAR_AGO)
  private Integer publishedYearAgo;

  public static final String SERIALIZED_NAME_PUBLISHED_TWO_YEARS_AGO = "publishedTwoYearsAgo";
  @SerializedName(SERIALIZED_NAME_PUBLISHED_TWO_YEARS_AGO)
  private Integer publishedTwoYearsAgo;

  public JifAggregate() { 
  }

  public JifAggregate count(String count) {
  ...
  **/
  ...
  public JifAggregate citesYearAgo(Integer citesYearAgo) {
    
    this.citesYearAgo = citesYearAgo;
    return this;
  }
  ...
  **/
  ...
  public Integer getCitesYearAgo() {
    return citesYearAgo;
  }


  public void setCitesYearAgo(Integer citesYearAgo) {
    this.citesYearAgo = citesYearAgo;
  }


  public JifAggregate citesTwoYearsAgo(Integer citesTwoYearsAgo) {
    
    this.citesTwoYearsAgo = citesTwoYearsAgo;
    return this;
  }

   /**
   * Get citesTwoYearsAgo
   * @return citesTwoYearsAgo
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getCitesTwoYearsAgo() {
    return citesTwoYearsAgo;
  }


  public void setCitesTwoYearsAgo(Integer citesTwoYearsAgo) {
    this.citesTwoYearsAgo = citesTwoYearsAgo;
  }


  public JifAggregate publishedYearAgo(Integer publishedYearAgo) {
    
    this.publishedYearAgo = publishedYearAgo;
    return this;
  }

   /**
   * Get publishedYearAgo
   * @return publishedYearAgo
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getPublishedYearAgo() {
    return publishedYearAgo;
  }


  public void setPublishedYearAgo(Integer publishedYearAgo) {
    this.publishedYearAgo = publishedYearAgo;
  }


  public JifAggregate publishedTwoYearsAgo(Integer publishedTwoYearsAgo) {
    
    this.publishedTwoYearsAgo = publishedTwoYearsAgo;
    return this;
  }

   /**
   * Get publishedTwoYearsAgo
   * @return publishedTwoYearsAgo
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getPublishedTwoYearsAgo() {
    return publishedTwoYearsAgo;
  }


  public void setPublishedTwoYearsAgo(Integer publishedTwoYearsAgo) {
    this.publishedTwoYearsAgo = publishedTwoYearsAgo;
  }
  ...
  public boolean equals(Object o) {
    ...
    JifAggregate jifAggregate = (JifAggregate) o;
    return Objects.equals(this.count, jifAggregate.count) &&
        Objects.equals(this.citesYearAgo, jifAggregate.citesYearAgo) &&
        Objects.equals(this.citesTwoYearsAgo, jifAggregate.citesTwoYearsAgo) &&
        Objects.equals(this.publishedYearAgo, jifAggregate.publishedYearAgo) &&
        Objects.equals(this.publishedTwoYearsAgo, jifAggregate.publishedTwoYearsAgo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, citesYearAgo, citesTwoYearsAgo, publishedYearAgo, publishedTwoYearsAgo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JifAggregate {\n");
    sb.append("    count: ").append(toIndentedString(count)).append("\n");
    sb.append("    citesYearAgo: ").append(toIndentedString(citesYearAgo)).append("\n");
    sb.append("    citesTwoYearsAgo: ").append(toIndentedString(citesTwoYearsAgo)).append("\n");
    sb.append("    publishedYearAgo: ").append(toIndentedString(publishedYearAgo)).append("\n");
    sb.append("    publishedTwoYearsAgo: ").append(toIndentedString(publishedTwoYearsAgo)).append("\n");
    sb.append("}");
    return sb.toString();
  }
