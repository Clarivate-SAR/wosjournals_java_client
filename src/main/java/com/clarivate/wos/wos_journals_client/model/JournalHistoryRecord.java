...
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordIsoTitle;
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordIssn;
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordName;
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordPublisher1;
...
public class JournalHistoryRecord {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private List<JournalHistoryRecordName> name = null;

  public static final String SERIALIZED_NAME_ISSN = "issn";
  @SerializedName(SERIALIZED_NAME_ISSN)
  private List<JournalHistoryRecordIssn> issn = null;

  public static final String SERIALIZED_NAME_PUBLISHER = "publisher";
  @SerializedName(SERIALIZED_NAME_PUBLISHER)
  private List<JournalHistoryRecordPublisher1> publisher = null;

  public static final String SERIALIZED_NAME_ISO_TITLE = "isoTitle";
  @SerializedName(SERIALIZED_NAME_ISO_TITLE)
  private List<JournalHistoryRecordIsoTitle> isoTitle = null;

  public JournalHistoryRecord() { 
  }

  public JournalHistoryRecord name(List<JournalHistoryRecordName> name) {
    
    this.name = name;
    return this;
  }

  public JournalHistoryRecord addNameItem(JournalHistoryRecordName nameItem) {
    if (this.name == null) {
      this.name = new ArrayList<JournalHistoryRecordName>();
    }
   ...
   /**
   * History of assigned names
   * @return name
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "History of assigned names")

  public List<JournalHistoryRecordName> getName() {
    return name;
  }


  public void setName(List<JournalHistoryRecordName> name) {
    this.name = name;
  }


  public JournalHistoryRecord issn(List<JournalHistoryRecordIssn> issn) {
    
    this.issn = issn;
    return this;
  }

  public JournalHistoryRecord addIssnItem(JournalHistoryRecordIssn issnItem) {
    if (this.issn == null) {
      this.issn = new ArrayList<JournalHistoryRecordIssn>();
    }
   ...
   /**
   * Previously assigned ISSN identifiers
   * @return issn
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Previously assigned ISSN identifiers")

  public List<JournalHistoryRecordIssn> getIssn() {
    return issn;
  }


  public void setIssn(List<JournalHistoryRecordIssn> issn) {
    this.issn = issn;
  }


  public JournalHistoryRecord publisher(List<JournalHistoryRecordPublisher1> publisher) {
    
    this.publisher = publisher;
    return this;
  }

  public JournalHistoryRecord addPublisherItem(JournalHistoryRecordPublisher1 publisherItem) {
    if (this.publisher == null) {
      this.publisher = new ArrayList<JournalHistoryRecordPublisher1>();
    }
   ...
   /**
   * Previously assigned publishers
   * @return publisher
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Previously assigned publishers")

  public List<JournalHistoryRecordPublisher1> getPublisher() {
    return publisher;
  }


  public void setPublisher(List<JournalHistoryRecordPublisher1> publisher) {
    this.publisher = publisher;
  }


  public JournalHistoryRecord isoTitle(List<JournalHistoryRecordIsoTitle> isoTitle) {
    
    this.isoTitle = isoTitle;
    return this;
  }

  public JournalHistoryRecord addIsoTitleItem(JournalHistoryRecordIsoTitle isoTitleItem) {
    if (this.isoTitle == null) {
      this.isoTitle = new ArrayList<JournalHistoryRecordIsoTitle>();
    }
    this.isoTitle.add(isoTitleItem);
    return this;
  }

   /**
   * Previously assigned ISO titles
   * @return isoTitle
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Previously assigned ISO titles")

  public List<JournalHistoryRecordIsoTitle> getIsoTitle() {
    return isoTitle;
  }


  public void setIsoTitle(List<JournalHistoryRecordIsoTitle> isoTitle) {
    this.isoTitle = isoTitle;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecord journalHistoryRecord = (JournalHistoryRecord) o;
    return Objects.equals(this.name, journalHistoryRecord.name) &&
        Objects.equals(this.issn, journalHistoryRecord.issn) &&
        Objects.equals(this.publisher, journalHistoryRecord.publisher) &&
        Objects.equals(this.isoTitle, journalHistoryRecord.isoTitle);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, issn, publisher, isoTitle);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalHistoryRecord {\n");
