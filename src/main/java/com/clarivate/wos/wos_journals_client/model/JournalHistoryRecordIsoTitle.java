...
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordYear3;
...
public class JournalHistoryRecordIsoTitle {
  ...
  private JournalHistoryRecordYear3 year;

  public JournalHistoryRecordIsoTitle() { 
  }

  public JournalHistoryRecordIsoTitle isoTitle(String isoTitle) {
  ...
  **/
  ...
  @ApiModelProperty(value = "ISO title")
  ...
  public JournalHistoryRecordIsoTitle year(JournalHistoryRecordYear3 year) {
  ...
  **/
  ...
  public JournalHistoryRecordYear3 getYear() {
    return year;
  }


  public void setYear(JournalHistoryRecordYear3 year) {
    this.year = year;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecordIsoTitle journalHistoryRecordIsoTitle = (JournalHistoryRecordIsoTitle) o;
    return Objects.equals(this.isoTitle, journalHistoryRecordIsoTitle.isoTitle) &&
        Objects.equals(this.year, journalHistoryRecordIsoTitle.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isoTitle, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalHistoryRecordIsoTitle {\n");
