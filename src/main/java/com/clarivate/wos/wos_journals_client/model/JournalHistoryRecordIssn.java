...
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordYear1;
...
public class JournalHistoryRecordIssn {
  ...
  private JournalHistoryRecordYear1 year;

  public JournalHistoryRecordIssn() { 
  }

  public JournalHistoryRecordIssn issn(String issn) {
  ...
  **/
  ...
  @ApiModelProperty(value = "ISSN identifier")
  ...
  public JournalHistoryRecordIssn year(JournalHistoryRecordYear1 year) {
  ...
  **/
  ...
  public JournalHistoryRecordYear1 getYear() {
    return year;
  }


  public void setYear(JournalHistoryRecordYear1 year) {
    this.year = year;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecordIssn journalHistoryRecordIssn = (JournalHistoryRecordIssn) o;
    return Objects.equals(this.issn, journalHistoryRecordIssn.issn) &&
        Objects.equals(this.year, journalHistoryRecordIssn.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issn, year);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalHistoryRecordIssn {\n");
