...
import com.clarivate.wos.wos_journals_client.model.JournalHistoryRecordYear;
...
public class JournalHistoryRecordName {
  ...
  private JournalHistoryRecordYear year;

  public JournalHistoryRecordName() { 
  }

  public JournalHistoryRecordName name(String name) {
  ...
  **/
  ...
  public JournalHistoryRecordName year(JournalHistoryRecordYear year) {
  ...
  **/
  ...
  public JournalHistoryRecordYear getYear() {
    return year;
  }


  public void setYear(JournalHistoryRecordYear year) {
    this.year = year;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecordName journalHistoryRecordName = (JournalHistoryRecordName) o;
    return Objects.equals(this.name, journalHistoryRecordName.name) &&
        Objects.equals(this.year, journalHistoryRecordName.year);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalHistoryRecordName {\n");
