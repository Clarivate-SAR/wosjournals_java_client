...
public class JournalHistoryRecordPublisher {
  ...
  public JournalHistoryRecordPublisher() { 
  }

  public JournalHistoryRecordPublisher name(String name) {
  ...
  **/
  ...
  public JournalHistoryRecordPublisher address(String address) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Publisher address")
  ...
  public JournalHistoryRecordPublisher countryRegion(String countryRegion) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Publisher country/region")
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecordPublisher journalHistoryRecordPublisher = (JournalHistoryRecordPublisher) o;
    return Objects.equals(this.name, journalHistoryRecordPublisher.name) &&
        Objects.equals(this.address, journalHistoryRecordPublisher.address) &&
        Objects.equals(this.countryRegion, journalHistoryRecordPublisher.countryRegion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, address, countryRegion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalHistoryRecordPublisher {\n");
