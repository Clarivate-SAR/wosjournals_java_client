...
public class JournalHistoryRecordYear {
  ...
  public JournalHistoryRecordYear() { 
  }

  public JournalHistoryRecordYear start(Integer start) {
  ...
  **/
  ...
  @ApiModelProperty(value = "First year of name")
  ...
  public JournalHistoryRecordYear end(Integer end) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Last year of name")
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecordYear journalHistoryRecordYear = (JournalHistoryRecordYear) o;
    return Objects.equals(this.start, journalHistoryRecordYear.start) &&
        Objects.equals(this.end, journalHistoryRecordYear.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalHistoryRecordYear {\n");
