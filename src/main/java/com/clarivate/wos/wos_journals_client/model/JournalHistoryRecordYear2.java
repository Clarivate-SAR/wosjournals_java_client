...
public class JournalHistoryRecordYear2 {
  ...
  public JournalHistoryRecordYear2() { 
  }

  public JournalHistoryRecordYear2 start(Integer start) {
   ...
   /**
   * First year of name, address, and country/region
   * @return start
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "First year of name, address, and country/region")
  ...
  public JournalHistoryRecordYear2 end(Integer end) {
   ...
   /**
   * Last year of name, address, and country/region
   * @return end
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Last year of name, address, and country/region")
  ...
  public boolean equals(Object o) {
    ...
    JournalHistoryRecordYear2 journalHistoryRecordYear2 = (JournalHistoryRecordYear2) o;
    return Objects.equals(this.start, journalHistoryRecordYear2.start) &&
        Objects.equals(this.end, journalHistoryRecordYear2.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalHistoryRecordYear2 {\n");
