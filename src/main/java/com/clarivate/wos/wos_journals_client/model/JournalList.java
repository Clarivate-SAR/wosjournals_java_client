...
import com.clarivate.wos.wos_journals_client.model.JournalListRecord;
...
public class JournalList {
  ...
  private List<JournalListRecord> hits = null;

  public JournalList() { 
  }

  public JournalList metadata(Metadata metadata) {
  ...
  **/
  ...
  public JournalList hits(List<JournalListRecord> hits) {
    
    this.hits = hits;
    return this;
  }

  public JournalList addHitsItem(JournalListRecord hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<JournalListRecord>();
    }
  ...
  **/
  ...
  public List<JournalListRecord> getHits() {
    return hits;
  }


  public void setHits(List<JournalListRecord> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalList journalList = (JournalList) o;
    return Objects.equals(this.metadata, journalList.metadata) &&
        Objects.equals(this.hits, journalList.hits);
  }
