...
import com.clarivate.wos.wos_journals_client.model.JournalListRecordJournalCitationReports;
import com.clarivate.wos.wos_journals_client.model.JournalListRecordMetrics;
import com.clarivate.wos.wos_journals_client.model.JournalListRecordRanks;
import com.clarivate.wos.wos_journals_client.model.SearchMatch;
...
public class JournalListRecord {
  ...
  private List<JournalListRecordJournalCitationReports> journalCitationReports = null;

  public static final String SERIALIZED_NAME_METRICS = "metrics";
  @SerializedName(SERIALIZED_NAME_METRICS)
  private JournalListRecordMetrics metrics;

  public static final String SERIALIZED_NAME_RANKS = "ranks";
  @SerializedName(SERIALIZED_NAME_RANKS)
  private JournalListRecordRanks ranks;

  public JournalListRecord() { 
  }

  public JournalListRecord id(String id) {
  ...
  **/
  ...
  public JournalListRecord self(String self) {
   ...
   /**
   * Link to the journal entity
   * @return self
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link to the journal entity")
  ...
  public JournalListRecord matches(List<SearchMatch> matches) {
    
    this.matches = matches;
    return this;
  }

  public JournalListRecord addMatchesItem(SearchMatch matchesItem) {
  ...
  **/
  ...
  public JournalListRecord name(String name) {
  ...
  **/
  ...
  public JournalListRecord categories(List<Object> categories) {
    
    this.categories = categories;
    return this;
  }

  public JournalListRecord addCategoriesItem(Object categoriesItem) {
  ...
  **/
  ...
  public JournalListRecord journalCitationReports(List<JournalListRecordJournalCitationReports> journalCitationReports) {
    
    this.journalCitationReports = journalCitationReports;
    return this;
  }

  public JournalListRecord addJournalCitationReportsItem(JournalListRecordJournalCitationReports journalCitationReportsItem) {
    if (this.journalCitationReports == null) {
      this.journalCitationReports = new ArrayList<JournalListRecordJournalCitationReports>();
    }
   ...
   /**
   * Journal citation report link (only if the filter \&quot;jcrYear\&quot; was selected)
   * @return journalCitationReports
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Journal citation report link (only if the filter \"jcrYear\" was selected)")

  public List<JournalListRecordJournalCitationReports> getJournalCitationReports() {
    return journalCitationReports;
  }


  public void setJournalCitationReports(List<JournalListRecordJournalCitationReports> journalCitationReports) {
    this.journalCitationReports = journalCitationReports;
  }


  public JournalListRecord metrics(JournalListRecordMetrics metrics) {
  ...
  **/
  ...
  public JournalListRecordMetrics getMetrics() {
    return metrics;
  }


  public void setMetrics(JournalListRecordMetrics metrics) {
    this.metrics = metrics;
  }


  public JournalListRecord ranks(JournalListRecordRanks ranks) {
  ...
  **/
  ...
  public JournalListRecordRanks getRanks() {
    return ranks;
  }


  public void setRanks(JournalListRecordRanks ranks) {
    this.ranks = ranks;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalListRecord journalListRecord = (JournalListRecord) o;
    return Objects.equals(this.id, journalListRecord.id) &&
        Objects.equals(this.self, journalListRecord.self) &&
        Objects.equals(this.matches, journalListRecord.matches) &&
        Objects.equals(this.name, journalListRecord.name) &&
        Objects.equals(this.categories, journalListRecord.categories) &&
        Objects.equals(this.journalCitationReports, journalListRecord.journalCitationReports) &&
        Objects.equals(this.metrics, journalListRecord.metrics) &&
        Objects.equals(this.ranks, journalListRecord.ranks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, self, matches, name, categories, journalCitationReports, metrics, ranks);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalListRecord {\n");
