...
public class JournalListRecordJournalCitationReports {
  ...
  public JournalListRecordJournalCitationReports() { 
  }

  public JournalListRecordJournalCitationReports year(Integer year) {
  ...
  **/
  ...
  @ApiModelProperty(value = "JCR Year (from 1997)")
  ...
  public JournalListRecordJournalCitationReports url(String url) {
   ...
   /**
   * Link to the related report
   * @return url
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link to the related report")
  ...
  public boolean equals(Object o) {
    ...
    JournalListRecordJournalCitationReports journalListRecordJournalCitationReports = (JournalListRecordJournalCitationReports) o;
    return Objects.equals(this.year, journalListRecordJournalCitationReports.year) &&
        Objects.equals(this.url, journalListRecordJournalCitationReports.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalListRecordJournalCitationReports {\n");
