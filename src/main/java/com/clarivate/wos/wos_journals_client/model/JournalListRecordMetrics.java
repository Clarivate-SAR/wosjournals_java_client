...
import com.clarivate.wos.wos_journals_client.model.JournalListRecordMetricsImpactMetrics;
import com.clarivate.wos.wos_journals_client.model.JournalListRecordMetricsSourceMetrics;
 ...
 */
@ApiModel(description = "Journal metrics information (only if the filter(s) \"jif\" or \"jifPercentile\" were selected)")
...
public class JournalListRecordMetrics {
  public static final String SERIALIZED_NAME_IMPACT_METRICS = "impactMetrics";
  @SerializedName(SERIALIZED_NAME_IMPACT_METRICS)
  private JournalListRecordMetricsImpactMetrics impactMetrics;

  public static final String SERIALIZED_NAME_SOURCE_METRICS = "sourceMetrics";
  @SerializedName(SERIALIZED_NAME_SOURCE_METRICS)
  private JournalListRecordMetricsSourceMetrics sourceMetrics;

  public JournalListRecordMetrics() { 
  }

  public JournalListRecordMetrics impactMetrics(JournalListRecordMetricsImpactMetrics impactMetrics) {
  ...
  **/
  ...
  public JournalListRecordMetricsImpactMetrics getImpactMetrics() {
    return impactMetrics;
  }


  public void setImpactMetrics(JournalListRecordMetricsImpactMetrics impactMetrics) {
    this.impactMetrics = impactMetrics;
  }


  public JournalListRecordMetrics sourceMetrics(JournalListRecordMetricsSourceMetrics sourceMetrics) {
  ...
  **/
  ...
  public JournalListRecordMetricsSourceMetrics getSourceMetrics() {
    return sourceMetrics;
  }


  public void setSourceMetrics(JournalListRecordMetricsSourceMetrics sourceMetrics) {
    this.sourceMetrics = sourceMetrics;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalListRecordMetrics journalListRecordMetrics = (JournalListRecordMetrics) o;
    return Objects.equals(this.impactMetrics, journalListRecordMetrics.impactMetrics) &&
        Objects.equals(this.sourceMetrics, journalListRecordMetrics.sourceMetrics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(impactMetrics, sourceMetrics);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalListRecordMetrics {\n");
