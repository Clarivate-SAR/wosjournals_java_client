...
import com.clarivate.wos.wos_journals_client.model.JournalListRecordRanksJci;
import com.clarivate.wos.wos_journals_client.model.JournalListRecordRanksJif;
 ...
 */
@ApiModel(description = "Journal ranks information (only if the filter \"jifQuartle\" was selected)")
...
public class JournalListRecordRanks {
  ...
  public JournalListRecordRanks() { 
  }

  public JournalListRecordRanks jif(List<JournalListRecordRanksJif> jif) {
    
    this.jif = jif;
    return this;
  }

  public JournalListRecordRanks addJifItem(JournalListRecordRanksJif jifItem) {
    if (this.jif == null) {
      this.jif = new ArrayList<JournalListRecordRanksJif>();
    }
  ...
  **/
  ...
  public List<JournalListRecordRanksJif> getJif() {
    return jif;
  }


  public void setJif(List<JournalListRecordRanksJif> jif) {
    this.jif = jif;
  }


  public JournalListRecordRanks jci(List<JournalListRecordRanksJci> jci) {
    
    this.jci = jci;
    return this;
  }

  public JournalListRecordRanks addJciItem(JournalListRecordRanksJci jciItem) {
    if (this.jci == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JournalListRecordRanks journalListRecordRanks = (JournalListRecordRanks) o;
    return Objects.equals(this.jif, journalListRecordRanks.jif) &&
        Objects.equals(this.jci, journalListRecordRanks.jci);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jif, jci);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalListRecordRanks {\n");
