...
public class JournalListRecordRanksJci {
  ...
  public static final String SERIALIZED_NAME_JCI_PERCENTILE = "jciPercentile";
  @SerializedName(SERIALIZED_NAME_JCI_PERCENTILE)
  private Double jciPercentile;

  public JournalListRecordRanksJci() { 
  }

  public JournalListRecordRanksJci category(String category) {
  ...
  **/
  ...
  public JournalListRecordRanksJci rank(String rank) {
  ...
  **/
  ...
  public JournalListRecordRanksJci quartile(String quartile) {
  ...
  **/
  ...
  public JournalListRecordRanksJci jciPercentile(Double jciPercentile) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JournalListRecordRanksJci journalListRecordRanksJci = (JournalListRecordRanksJci) o;
    return Objects.equals(this.category, journalListRecordRanksJci.category) &&
        Objects.equals(this.rank, journalListRecordRanksJci.rank) &&
        Objects.equals(this.quartile, journalListRecordRanksJci.quartile) &&
        Objects.equals(this.jciPercentile, journalListRecordRanksJci.jciPercentile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, rank, quartile, jciPercentile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalListRecordRanksJci {\n");
    sb.append("    category: ").append(toIndentedString(category)).append("\n");
    sb.append("    rank: ").append(toIndentedString(rank)).append("\n");
    sb.append("    quartile: ").append(toIndentedString(quartile)).append("\n");
    sb.append("    jciPercentile: ").append(toIndentedString(jciPercentile)).append("\n");
    sb.append("}");
    return sb.toString();
  }
