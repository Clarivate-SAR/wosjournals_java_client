 ...
 */
@ApiModel(description = "Open access citable items for the three years. Detailed information could be found in [this page](http://jcr.help.clarivate.com/Content/open-access.htm)")
...
public class JournalProfileCitableItems {
  ...
  public JournalProfileCitableItems() { 
  }

  public JournalProfileCitableItems goldOA(Integer goldOA) {
  ...
  **/
  ...
  public JournalProfileCitableItems subscription(Integer subscription) {
  ...
  **/
  ...
  public JournalProfileCitableItems other(Integer other) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JournalProfileCitableItems journalProfileCitableItems = (JournalProfileCitableItems) o;
    return Objects.equals(this.goldOA, journalProfileCitableItems.goldOA) &&
        Objects.equals(this.subscription, journalProfileCitableItems.subscription) &&
        Objects.equals(this.other, journalProfileCitableItems.other);
  }

  @Override
  public int hashCode() {
    return Objects.hash(goldOA, subscription, other);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalProfileCitableItems {\n");
