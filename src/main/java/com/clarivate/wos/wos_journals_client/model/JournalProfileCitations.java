 ...
 */
@ApiModel(description = "Open access citations for the three years. Detailed information could be found in [this page](http://jcr.help.clarivate.com/Content/open-access.htm)")
...
public class JournalProfileCitations {
  public static final String SERIALIZED_NAME_GOLD_O_A = "goldOA";
  @SerializedName(SERIALIZED_NAME_GOLD_O_A)
  private Integer goldOA;
  ...
  public JournalProfileCitations() { 
  }

  public JournalProfileCitations goldOA(Integer goldOA) {
  ...
  **/
  ...
  public Integer getGoldOA() {
    return goldOA;
  }


  public void setGoldOA(Integer goldOA) {
    this.goldOA = goldOA;
  }


  public JournalProfileCitations subscription(Integer subscription) {
  ...
  **/
  ...
  public JournalProfileCitations other(Integer other) {
  ...
  **/
  ...
  public JournalProfileCitations unlinked(Integer unlinked) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JournalProfileCitations journalProfileCitations = (JournalProfileCitations) o;
    return Objects.equals(this.goldOA, journalProfileCitations.goldOA) &&
        Objects.equals(this.subscription, journalProfileCitations.subscription) &&
        Objects.equals(this.other, journalProfileCitations.other) &&
        Objects.equals(this.unlinked, journalProfileCitations.unlinked);
  }

  @Override
  public int hashCode() {
    return Objects.hash(goldOA, subscription, other, unlinked);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalProfileCitations {\n");
    sb.append("    goldOA: ").append(toIndentedString(goldOA)).append("\n");
