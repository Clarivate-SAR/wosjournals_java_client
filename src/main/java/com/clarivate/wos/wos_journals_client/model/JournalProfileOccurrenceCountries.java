...
public class JournalProfileOccurrenceCountries {
  ...
  public JournalProfileOccurrenceCountries() { 
  }

  public JournalProfileOccurrenceCountries countryRegion(String countryRegion) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Country/region name")
  ...
  public JournalProfileOccurrenceCountries occurrence(Integer occurrence) {
   ...
   /**
   * Number of country/region&#39;s articles/reviews/etc
   * @return occurrence
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of country/region's articles/reviews/etc")
  ...
  public boolean equals(Object o) {
    ...
    JournalProfileOccurrenceCountries journalProfileOccurrenceCountries = (JournalProfileOccurrenceCountries) o;
    return Objects.equals(this.countryRegion, journalProfileOccurrenceCountries.countryRegion) &&
        Objects.equals(this.occurrence, journalProfileOccurrenceCountries.occurrence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(countryRegion, occurrence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalProfileOccurrenceCountries {\n");
