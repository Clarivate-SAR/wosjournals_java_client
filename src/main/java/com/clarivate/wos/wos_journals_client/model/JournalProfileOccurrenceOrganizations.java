...
public class JournalProfileOccurrenceOrganizations {
  ...
  public JournalProfileOccurrenceOrganizations() { 
  }

  public JournalProfileOccurrenceOrganizations organization(String organization) {
  ...
  **/
  ...
  public JournalProfileOccurrenceOrganizations occurrence(Integer occurrence) {
   ...
   /**
   * Number of organization&#39;s articles/reviews/etc
   * @return occurrence
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of organization's articles/reviews/etc")
  ...
  public boolean equals(Object o) {
    ...
    JournalProfileOccurrenceOrganizations journalProfileOccurrenceOrganizations = (JournalProfileOccurrenceOrganizations) o;
    return Objects.equals(this.organization, journalProfileOccurrenceOrganizations.organization) &&
        Objects.equals(this.occurrence, journalProfileOccurrenceOrganizations.occurrence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(organization, occurrence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalProfileOccurrenceOrganizations {\n");
