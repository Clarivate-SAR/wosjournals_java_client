 ...
 */
@ApiModel(description = "Main information about the report journal")
...
public class JournalReportsJournal {
  ...
  public JournalReportsJournal() { 
  }

  public JournalReportsJournal id(String id) {
  ...
  **/
  ...
  public JournalReportsJournal self(String self) {
   ...
   /**
   * Journals API link to the journal entity
   * @return self
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Journals API link to the journal entity")
  ...
  public JournalReportsJournal name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JournalReportsJournal journalReportsJournal = (JournalReportsJournal) o;
    return Objects.equals(this.id, journalReportsJournal.id) &&
        Objects.equals(this.self, journalReportsJournal.self) &&
        Objects.equals(this.name, journalReportsJournal.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, self, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalReportsJournal {\n");
