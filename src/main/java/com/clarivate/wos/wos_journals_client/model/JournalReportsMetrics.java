...
import com.clarivate.wos.wos_journals_client.model.ImpactMetrics;
import com.clarivate.wos.wos_journals_client.model.InfluenceMetrics;
import com.clarivate.wos.wos_journals_client.model.SourceMetrics;
 ...
 */
@ApiModel(description = "Key metrics information, including Impact Metrics (such as Journal Impact Factor), Influence Metrics (such as Eigen Factor), and Source Metrics (such as Citation Half-Life)")
...
public class JournalReportsMetrics {
  ...
  public static final String SERIALIZED_NAME_INFLUENCE_METRICS = "influenceMetrics";
  @SerializedName(SERIALIZED_NAME_INFLUENCE_METRICS)
  private InfluenceMetrics influenceMetrics;
  ...
  public JournalReportsMetrics() { 
  }

  public JournalReportsMetrics impactMetrics(ImpactMetrics impactMetrics) {
  ...
  **/
  ...
  public void setImpactMetrics(ImpactMetrics impactMetrics) {
    this.impactMetrics = impactMetrics;
  }


  public JournalReportsMetrics influenceMetrics(InfluenceMetrics influenceMetrics) {
   ...
   /**
   * Get influenceMetrics
   * @return influenceMetrics
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public InfluenceMetrics getInfluenceMetrics() {
    return influenceMetrics;
  }


  public void setInfluenceMetrics(InfluenceMetrics influenceMetrics) {
    this.influenceMetrics = influenceMetrics;
  }


  public JournalReportsMetrics sourceMetrics(SourceMetrics sourceMetrics) {
  ...
  **/
  ...
  public void setSourceMetrics(SourceMetrics sourceMetrics) {
    this.sourceMetrics = sourceMetrics;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalReportsMetrics journalReportsMetrics = (JournalReportsMetrics) o;
    return Objects.equals(this.impactMetrics, journalReportsMetrics.impactMetrics) &&
        Objects.equals(this.influenceMetrics, journalReportsMetrics.influenceMetrics) &&
        Objects.equals(this.sourceMetrics, journalReportsMetrics.sourceMetrics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(impactMetrics, influenceMetrics, sourceMetrics);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JournalReportsMetrics {\n");
    sb.append("    impactMetrics: ").append(toIndentedString(impactMetrics)).append("\n");
    sb.append("    influenceMetrics: ").append(toIndentedString(influenceMetrics)).append("\n");
