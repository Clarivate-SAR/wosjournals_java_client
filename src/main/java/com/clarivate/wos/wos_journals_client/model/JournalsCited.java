...
import com.clarivate.wos.wos_journals_client.model.JournalsCitedHits;
...
public class JournalsCited {
  ...
  private List<JournalsCitedHits> hits = null;

  public JournalsCited() { 
  }

  public JournalsCited metadata(Metadata metadata) {
  ...
  **/
  ...
  public JournalsCited hits(List<JournalsCitedHits> hits) {
    
    this.hits = hits;
    return this;
  }

  public JournalsCited addHitsItem(JournalsCitedHits hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<JournalsCitedHits>();
    }
  ...
  **/
  ...
  public List<JournalsCitedHits> getHits() {
    return hits;
  }


  public void setHits(List<JournalsCitedHits> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalsCited journalsCited = (JournalsCited) o;
    return Objects.equals(this.metadata, journalsCited.metadata) &&
        Objects.equals(this.hits, journalsCited.hits);
  }
