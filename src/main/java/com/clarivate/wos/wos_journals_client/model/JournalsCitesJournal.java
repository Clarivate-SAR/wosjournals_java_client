...
public class JournalsCitesJournal {
  ...
  public JournalsCitesJournal() { 
  }

  public JournalsCitesJournal self(String self) {
  ...
  **/
  ...
  public JournalsCitesJournal name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JournalsCitesJournal journalsCitesJournal = (JournalsCitesJournal) o;
    return Objects.equals(this.self, journalsCitesJournal.self) &&
        Objects.equals(this.name, journalsCitesJournal.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalsCitesJournal {\n");
