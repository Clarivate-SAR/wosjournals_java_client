...
import com.clarivate.wos.wos_journals_client.model.JournalsCitingHits;
...
public class JournalsCiting {
  ...
  private List<JournalsCitingHits> hits = null;

  public JournalsCiting() { 
  }

  public JournalsCiting metadata(Metadata metadata) {
  ...
  **/
  ...
  public JournalsCiting hits(List<JournalsCitingHits> hits) {
    
    this.hits = hits;
    return this;
  }

  public JournalsCiting addHitsItem(JournalsCitingHits hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<JournalsCitingHits>();
    }
  ...
  **/
  ...
  public List<JournalsCitingHits> getHits() {
    return hits;
  }


  public void setHits(List<JournalsCitingHits> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalsCiting journalsCiting = (JournalsCiting) o;
    return Objects.equals(this.metadata, journalsCiting.metadata) &&
        Objects.equals(this.hits, journalsCiting.hits);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalsCiting {\n");
