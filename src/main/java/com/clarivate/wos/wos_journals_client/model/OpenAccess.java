 ...
 */
@ApiModel(description = "Journal open access status")
...
public class OpenAccess {
  ...
  public OpenAccess startYear(Integer startYear) {
   ...
   /**
   * First year of journal open access
   * @return startYear
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "First year of journal open access")
  ...
  public OpenAccess endYear(Integer endYear) {
   ...
   /**
   * Last year of journal open access
   * @return endYear
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Last year of journal open access")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startYear, openAccess.startYear) &&
        Objects.equals(this.endYear, openAccess.endYear);
  }
