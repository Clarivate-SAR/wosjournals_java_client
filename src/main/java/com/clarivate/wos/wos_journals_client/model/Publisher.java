 ...
 */
@ApiModel(description = "Information about the journal publisher")
...
public class Publisher {
  ...
  **/
  ...
  @ApiModelProperty(value = "Publisher unique identifier")
  ...
  **/
  ...
  public Publisher countryRegion(String countryRegion) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, publisher.id) &&
        ...
        Objects.equals(this.countryRegion, publisher.countryRegion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, address, countryRegion);
  }
