 ...
 */
@ApiModel(description = "Information about number of citable items in the JCR year. For the detailed description how this data is calculated please visit [this page](http://jcr.help.clarivate.com/Content/source-data.htm?Highlight=Source%20Data)")
...
public class SourceData {
  ...
  public SourceData articles(SourceDataArticles articles) {
  ...
  **/
  ...
  public SourceDataArticles getArticles() {
    return articles;
  }


  public void setArticles(SourceDataArticles articles) {
    this.articles = articles;
  }


  public SourceData reviews(SourceDataArticles reviews) {
  ...
  **/
  ...
  public SourceDataArticles getReviews() {
    return reviews;
  }


  public void setReviews(SourceDataArticles reviews) {
    this.reviews = reviews;
  }


  public SourceData other(SourceDataArticles other) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.articles, sourceData.articles) &&
        Objects.equals(this.reviews, sourceData.reviews) &&
        Objects.equals(this.other, sourceData.other);
  }
