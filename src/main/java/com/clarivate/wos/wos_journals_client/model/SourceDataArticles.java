...
public class SourceDataArticles {
  ...
  public SourceDataArticles() { 
  }

  public SourceDataArticles count(Integer count) {
  ...
  **/
  ...
  public SourceDataArticles references(Integer references) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SourceDataArticles sourceDataArticles = (SourceDataArticles) o;
    return Objects.equals(this.count, sourceDataArticles.count) &&
        Objects.equals(this.references, sourceDataArticles.references);
  }
  ...
  public String toString() {
    ...
    sb.append("class SourceDataArticles {\n");
