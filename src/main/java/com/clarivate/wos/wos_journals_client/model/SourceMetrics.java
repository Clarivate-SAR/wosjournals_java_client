...
import com.clarivate.wos.wos_journals_client.model.HalfLife;
import com.clarivate.wos.wos_journals_client.model.SourceMetricsCitableItems;
...
public class SourceMetrics {
  ...
  private SourceMetricsCitableItems citableItems;

  public static final String SERIALIZED_NAME_JIF_PERCENTILE = "jifPercentile";
  @SerializedName(SERIALIZED_NAME_JIF_PERCENTILE)
  ...
  public SourceMetrics citableItems(SourceMetricsCitableItems citableItems) {
  ...
  **/
  ...
  public SourceMetricsCitableItems getCitableItems() {
    return citableItems;
  }


  public void setCitableItems(SourceMetricsCitableItems citableItems) {
    this.citableItems = citableItems;
  }


  public SourceMetrics jifPercentile(Double jifPercentile) {
   ...
   /**
   * Average Journal Impact Factor Percentile. Detailed information could be found in [this page](http://jcr.help.clarivate.com/Content/glossary-average-jif-percentile.htm)
   * @return jifPercentile
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Average Journal Impact Factor Percentile. Detailed information could be found in [this page](http://jcr.help.clarivate.com/Content/glossary-average-jif-percentile.htm)")
  ...
  public SourceMetrics halfLife(HalfLife halfLife) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.citableItems, sourceMetrics.citableItems) &&
        Objects.equals(this.jifPercentile, sourceMetrics.jifPercentile) &&
        Objects.equals(this.halfLife, sourceMetrics.halfLife);
  }

  @Override
  public int hashCode() {
    return Objects.hash(citableItems, jifPercentile, halfLife);
  }
  ...
  public String toString() {
    ...
    sb.append("    jifPercentile: ").append(toIndentedString(jifPercentile)).append("\n");
