...
public class SourceMetricsCitableItems {
  public static final String SERIALIZED_NAME_TOTAL = "total";
  @SerializedName(SERIALIZED_NAME_TOTAL)
  private Integer total;

  public static final String SERIALIZED_NAME_ARTICLES_PERCENTAGE = "articlesPercentage";
  @SerializedName(SERIALIZED_NAME_ARTICLES_PERCENTAGE)
  private Double articlesPercentage;

  public SourceMetricsCitableItems() { 
  }

  public SourceMetricsCitableItems total(Integer total) {
  ...
  **/
  ...
  public SourceMetricsCitableItems articlesPercentage(Double articlesPercentage) {
    
    this.articlesPercentage = articlesPercentage;
    return this;
  }

   /**
   * Get articlesPercentage
   * @return articlesPercentage
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Double getArticlesPercentage() {
    return articlesPercentage;
  }


  public void setArticlesPercentage(Double articlesPercentage) {
    this.articlesPercentage = articlesPercentage;
  }
  ...
  public boolean equals(Object o) {
    ...
    SourceMetricsCitableItems sourceMetricsCitableItems = (SourceMetricsCitableItems) o;
    return Objects.equals(this.total, sourceMetricsCitableItems.total) &&
        Objects.equals(this.articlesPercentage, sourceMetricsCitableItems.articlesPercentage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(total, articlesPercentage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SourceMetricsCitableItems {\n");
    sb.append("    total: ").append(toIndentedString(total)).append("\n");
    sb.append("    articlesPercentage: ").append(toIndentedString(articlesPercentage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
